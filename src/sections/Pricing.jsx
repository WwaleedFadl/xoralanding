      ...
      <Element name={"pricing"}>
        <div className='container'>
          ...
          >
            ...
            <div
              className={`relative z-4 mx-auto flex w-[375px] rounded-3xl border-[3px] border-s4/25 bg-s1/50 p-2 backdrop-blue-[6px] max-ms:w-[310px]`}
            >
              <button
          ...
          <div
            className={
              "scroll-hide relative z-2 -mt-12 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6"
            }
          >
              ...
              return (
                ...
                >
                  {index === 1 && (
                    <div
                      className={
                        "g4 absolute h-330 left-0 right-0 top-0 z-1 rounded-tl-3xl rounded-tr-3xl "
                      }
                    />
                  )}
                  <div
